        ...
        <>
            <footer class="footer footer-big " style={{ backgroundColor: '#0F0F0F' }}>
                <div class="container">
                    <div class="content">
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                ...
                                <div class="row col-md-12 align-items-center mr-0 mt-5 mailInput">

                                    <div class="col-md-4  text-center pr-0 mt-2 ">
                                        <button class="btn btn-danger rounded-pill pr-4 pl-4 mt-0" type="button">שלח</button>
                                    </div>

                                    <div class=" input-group col-md-8 pl-0" style={{ width: '65%' }} >
                    ...
                    <hr />
                    <div class="row whiteColor" style={{ marginTop: '2.5%' }}>
