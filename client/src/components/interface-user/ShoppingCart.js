                        ...
                        <div className=" bg-grey col-8  px-5 pb-3" style={{ overflowY: 'scroll', height: '470px' }}>
                            ...
                            {productsInCart.map(item =>
                                ...
                                <div className={`productItem mb-2 row justify-content-between align-items-end border-bottom border-dark py-2 ${item.product._id} `}>
                                    ...
                                    <div className='col-2 amountToBuy goldColor d-flex align-items-end'>+<div className='border text-black bg-white pt-0 pb-0 pl-2 pr-2  m-1 my-0' style={{ fontSize: '13px' }}>{item.Amount}</div>-</div>
                                    <div className='col-2 price h6 mb-0 font-weight-bold  goldColor ' >14.90 &#8362; </div>

                                    <div className='sumColumnVal col-2 endprice h6 mb-0 font-weight-bold pr-5 ' >{item.Amount * 14.90} &#8362; </div>
